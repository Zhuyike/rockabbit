...
class CommandManager:
    ...
    def _find_command(self,
        ...
        if '[CQ:image,' in cmd_name[0]:
            return cmd_tree.get('cq_image_tongji____xxxx')
        if '[CQ:rich,content={"detail' in cmd_name[0]:
            return cmd_tree.get('zhuanfazhuanfazhuanfa')
        if '[CQ:rich,content={"news' in cmd_name[0]:
            return cmd_tree.get('zhuanfazhuanfazhuanfa_2')
        if '[CQ:rich,text=' in cmd_name[0]:
            return cmd_tree.get('zhuanfazhuanfazhuanfa_hd')
